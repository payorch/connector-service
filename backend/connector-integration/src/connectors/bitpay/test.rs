...
mod tests {
    pub mod authorize {
        ...
        fn test_build_request_valid() {
            ...
            > = RouterDataV2 {
                ...
                resource_common_data: PaymentFlowData {
                    ...
                    connectors: Connectors {
                        ...
                        bitpay: ConnectorParams {
                            base_url: "https://bitpay.com/api/".to_string(),
                        },
                    },
            ...
            let connector: BoxedConnector = Box::new(Bitpay::new());
            let connector_data = ConnectorData {
                connector,
                connector_name: ConnectorEnum::Bitpay,
            };
            ...
            println!("request: {:?}", req);
            assert_eq!(req.as_ref().unwrap()["orderId"], "conn_ref_123456789");
        }
        ...
        fn test_handle_response_v2_valid_authorize_response() {
            ...
            let response = hyperswitch_interfaces::types::Response {
                status_code: 200,
                headers: vec![],
                body: r#"{
                    "status": "processing",
                    "id": "bitpay_txn_123456",
                    "url": "https://bitpay.com/checkout/123456"
                }"#
                .as_bytes()
                .to_vec(),
            };
