...
mod tests {
    pub mod authorize {
        use crate::connectors::Checkout;
        use crate::types::ConnectorData;
        use domain_types::connector_flow::Authorize;
        use domain_types::connector_types::{
            BoxedConnector, ConnectorEnum, ConnectorServiceTrait, PaymentFlowData, PaymentsAuthorizeData,
            PaymentsResponseData,
        };
        use domain_types::types::{ConnectorParams, Connectors};
        use hyperswitch_common_enums::AttemptStatus;
        ...
        fn test_build_request_valid() {
            ...
            let connector: BoxedConnector = Box::new(Checkout::new());
            let connector_data = ConnectorData {
                connector,
                connector_name: ConnectorEnum::Checkout,
            };
        ...
        fn test_handle_response_v2_valid_authorize_response() {
            ...
            let http_response = Response {
                ...
                response: br#"{
                    ...
                    "action": {
                        "type": "redirect",
                        "url": "https://api.checkout.com/3ds/redirect"
                    },
                    "status": "pending"
                }"#
                .to_vec()
